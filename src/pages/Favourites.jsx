      ...
      <div className="container mx-auto max-w-7xl p-6 pb-12">
        ...
        {!loading && movies?.length === 0 && (
          <div className="flex flex-col">
            ...
            <Link
              to="/search"
              className="self-start border-2 border-[#68ded7] text-white uppercase px-10 py-2 tracking-widest font-semibold hover:bg-[#68ded7] hover:text-black text-sm md:text-base
              duration-150 ease"
            >
              Browse movies
            </Link>
